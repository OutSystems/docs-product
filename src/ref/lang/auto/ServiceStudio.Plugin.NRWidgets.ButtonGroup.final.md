...
<p>When used inside List Records or Table Records we need to manually add the attribute "name" for each radio button that is part of a Button Group so that the platform can properly bind them:</p> 
<br/>
