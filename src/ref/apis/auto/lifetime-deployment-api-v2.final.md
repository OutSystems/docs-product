...
|[GET /deployments/&#123;DeploymentKey&#125;/](#get-deployments-deploymentkey)|Returns the details of a given deployment. The returned information contains the included applications and the possible conflicts that can arise from the deployment of the current applications. Executing this method may alter the deployment status, as it performs a validation process to gather the described information.|
