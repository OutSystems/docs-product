...
To add the SSL Pinning verification, you must install the [SSL Pinning component](https://www.outsystems.com/forge/component-overview/1873/ssl-pinning-plugin) from [Forge](https://www.outsystems.com/forge/) in your environment. 
