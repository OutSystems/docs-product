---
summary: OutSystems 11 (O11) Timers execute asynchronous logic on a schedule, managed by the Scheduler Service with priority, timeout, and session isolation rules.
locale: en-us
