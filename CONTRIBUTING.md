# How to contribute with our documentation
...
1. Give a name to your file in the format `[filename].md`:
...
1. Add your content to the new file. To preview the content, click Preview.
...
1. After you have added all the content, scroll down, add a description, and click Propose new file:

![Screenshot of the Propose New File button on GitHub after creating a document](images/new-propose-git.png "Propose New File on GitHub")

1. To submit your new content for approval, click Create Pull Request:
...
1. Clone your forks to your computer
...
1. Run the binary and follow the installation steps.
...
1. Search for the extension and install it.
...
1. Select your account in the pop-up.
1. A copy of the repository is created within your account.
...
1. Enter _clone_
1. Select the Git: Clone option.
1. Paste the URL of your fork, and press ENTER
1. Select a folder on your computer to save the repository files.
1. Wait until the repository is cloned (If you haven't already logged into GitHub, you may need to do so at this point.).
1. After the cloning completes a notification appears, click Open.
...
1. Create Branches for bigger contributions
...
1. After you have completed your work in the branch, you should merge it with the master in your fork.
...
1. On the Compare page, click compare across forks.
1. In the base branch drop-down menu, select the branch of the upstream repository you want to merge the changes into.
1. In the head fork drop-down menu, select your fork, and then use the compare branch drop-down menu to select the branch you made your changes in.
