...
## Create a connection to a SAP system from your application
...
On the **Logic** tab, go to **Integrations** > **SAP**. OutSystems does the following for you:
...
1. **Connect to SAP & Begin Context:** The connection is established to SAP, using the default credentials if no different authentication is defined, and a context in SAP is started for calling the SAP remote function. 
