...
Attribute belonging to a structure used in input arguments of REST API Multipart Requests. For more information on Multipart Requests, see [Consuming a REST API with a multipart/form data method](../../../../extensibility-and-integration/rest/consume-rest-apis/consume-multipart-form-data.md).  
