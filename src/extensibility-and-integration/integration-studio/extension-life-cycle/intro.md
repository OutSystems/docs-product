...
1. [Define the new actions](<extension-define.md>) that will encapsulate your code. Also define any input and output parameters for your action(s), as well as any entities or structures.
...
1. [Publish the extension module](<extension-1-cp.md>) to the Platform Server from Integration Studio by clicking 1-Click Publish ![](images/1-click-publish-icon.gif) in the File menu or Toolbar.
