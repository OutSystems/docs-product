...
|---|---|
| Trigger (Trigger Identifier): Optional  | Define when the flip event is triggered. The predefined options are:<p><ul><li>Click</li><li>Hover</li><li>Manual</li></ul></p><p>Examples <ul><li>_Blank_ - The flip event is triggered when the hovers over it (default value).<li>_Entities.Trigger.Click_ - The flip event is triggered when the user clicks it.</li><li>_Entities.Trigger.Hover_ -  The flip event is triggered when the user hovers over it.</li></ul></p>|  
