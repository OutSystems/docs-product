...
[UserSessionInfo](<#Structure_UserSessionInfo>) | Structure to handle the user information during their session.
...
Structure to handle the user information during their session.
