---
summary: OutSystems 11 (O11) details the properties and configurations of output parameters in consumed SOAP Web Services.
locale: en-us
guid: 56426f22-13b5-4e4f-a87a-dd37eba728cf
app_type: traditional web apps, mobile apps, reactive web apps
platform-version: o11
figma:
tags: soap integration, web services, data mapping, api documentation, service-oriented architecture
audience:
  - mobile developers
  - frontend developers
