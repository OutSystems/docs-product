...
In the **Android section** of the Extensibility Configurations JSON, add a preference item with `GooglePlayAppSigningCertificate` as its name **name** and **value** with the public key. Here is an example:
