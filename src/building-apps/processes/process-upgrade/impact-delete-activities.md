---
summary: "OutSystems 11 (O11) process instance behavior when activities are deleted from a flow: suspension risks, Decision tool workaround, and BAM monitoring."
locale: en-us
