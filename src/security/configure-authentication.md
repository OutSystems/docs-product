...
1. Select the **Applications Authentication** area:
...
1. The request contains the two authentication cookies.
1. Cookies information is authentic and was not forged.
1. Login expiration period has not been reached.
