...
|[POST /deployments/&#123;DeploymentKey&#125;/&#123;Command&#125;/](#post-deployments-deploymentkey-command)| Executes the given command in a specified deployment. The allowed commands are “start”, “continue” and “abort”. Starting with LifeTime 11.24.0, it is possible to execute multiple deployment plans for the same target environment in parallel. |
