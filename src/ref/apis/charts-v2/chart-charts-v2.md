...
tags:
  ...
  - UI
  - Widgets
summary: OutSystems 11 (O11) Charts API v2 reference covering chart types, add-ons, and Highcharts 12.6.0 client actions for customization.
locale: en-us
...
The Charts API v2 allows you to create, populate, and customize charts. OutSystems uses Highcharts 12.6.0 to generate the charts. For more information about implementation and the API, see the [Highcharts documentation](https://api.highcharts.com/highcharts/).
