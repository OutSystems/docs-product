...
### Is it possible to use AI Mentor Studio without giving consent to share personal information?
...
### If a user wants to exercise any right to access, correct, or erase their personal data, including obtaining information about what type of personal data is stored in AI Mentor Studio, what should the user do?
...
### If a user wants to have their data erased from AI Mentor Studio, what should the user do?
