...
tags:
  ...
  - Forge
  - Technical Debt
summary: OutSystems 11 (O11) allows selective ignoring of modules during technical debt analysis to provide a more accurate assessment in Code Quality.
...
**Code Quality** gives architects and team leads the ability to ignore individual modules—or to bulk-select whole classes of modules—so they will be ignored during the technical debt evaluation of your factory’s portfolio.

<div class="info" markdown="1">

For more information about permissions to access this feature, see [How does Code Quality work](https://success.outsystems.com/Documentation/11/Managing_the_Applications_Lifecycle/Manage_technical_debt/How_does_Architecture_Dashboard_work#Permissions).

</div>

To select modules to ignore:

1. Go to the **Maintenance** tab of **Code Quality**.
    ![Screenshot of Code Quality with the Maintenance tab highlighted](images/select-maintenance-ams.png "Selecting the Maintenance Tab in Code Quality")
1. On the **Maintenance** page, click **Ignored Modules** to get a list of all modules in your infrastructure, which includes filtering options for finding specific modules to ignore.
    ![Main page of Ignored Modules in Code Quality showing filtering options](images/ignored-modules-main-page-ams.png "Ignored Modules Main Page in Code Quality")
...
Ignoring **[Forge](https://www.outsystems.com/forge/)** components in **Code Quality** is another good practice. **OutSystems** developers rely on the **Forge** to accelerate the design process. Components that are used as-is do not have to be included when calculating your infrastructure’s technical debt.

To ignore **Forge** components in technical debt analysis:

1. Go to the **Maintenance** tab and click **Ignored Modules**.
...
1. Click the select all box in the header.
    ...
    ![Select all checkbox for bulk ignoring modules in Code Quality](images/bulk-actions-ams.png "Bulk Actions for Ignoring Modules in Code Quality")
1. The information area under the filters tells you how many modules have been selected on the current page. Click **Select all &lt;n> items on this list** to add **Forge** components on all pages to the selection.
    ![Information area indicating the number of modules selected to ignore in Code Quality](images/select-all-ams.png "Select All Items for Ignoring in Code Quality")

1. The information area now tells you that all components on all pages have been selected. Click **Change to Ignored**.
    ![Button to change selected modules to Ignored status in Code Quality](images/change-to-ignored-ams.png "Changing Modules to Ignored Status in Code Quality")
...
1. Click **Change to Ignored**.
    ![Process of selecting individual modules to ignore in Code Quality](images/individually-ignored-modules-ams.png "Individually Ignoring Modules in Code Quality")
