...
![Diagram illustrating the key steps for creating and customizing a use-case app in OutSystems](images/create-your-app-use-case-diag.png "Creating and Customizing Your App Process Diagram")
