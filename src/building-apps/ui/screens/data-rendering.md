...
Do not design list items with expandable content, such as a trimmed description that has a 'Show All...' link. This impacts the behavior of the list while rendering. Use OutSystems UI patterns such as [MasterDetail](../patterns/mobile/adaptive/masterdetail.md) instead.
...
To learn more about optimizing data rendering, read the [From Web to Mobile Development: 5 Things to Consider](https://www.outsystems.com/blog/posts/convert-website-to-app-what-to-consider/) blog post.
