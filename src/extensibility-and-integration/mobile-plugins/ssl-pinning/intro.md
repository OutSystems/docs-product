...
SSL Pinning uses a customized version of the SSL certificate validation and does not rely on deprecated SSL Pinning in browsers.
...
1. Validate the certificates against the hashes in the mobile app.
...
If you're using the [OutSystems personal environment](https://success.outsystems.com/Support/Personal_Environment/What's_an_OutSystems_personal_environment%3F?_gl=1%2A3g6x1t%2A_ga%2AMTk4NjU1MDIwMi4xNTg0MDI3MjI1%2A_ga_ZD4DTMHWR2%2AMTYxMTg0MTkyOC44MS4xLjE2MTE4NDI4NjAuMjI.), use a dummy text for the second hash key, as there’s only one certificate and hash key available for this environment.
...
To add the SSL Pinning verification, you must install the SSL Pinning component from the [Forge](https://www.outsystems.com/forge/) in your environment. 
...
Currently, handling [Blob](https://developer.mozilla.org/en-US/docs/Web/API/Blob) objects is not supported in Android when SSL Pinning is enabled.