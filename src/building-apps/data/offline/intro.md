---
summary: OutSystems 11 (O11) offline data sync for mobile apps and PWAs using SQLite, IndexedDB, local storage modeling, and a 4-step sync implementation process.
