...
In fact, "_the best way to optimize access to a database is not to access it at all_". Focused application caching strategies are key to optimize workloads of your applications.
